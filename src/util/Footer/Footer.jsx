      ...
      <div className="grid md:grid-cols-3  lg:container lg:mx-auto lg:py-6 lg:px-16 ">
        ...
        <div className='col-span-4 md:col-span-1 p-3 md:p-5'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-1 lg:grid-cols-2'>
            <div className='text-[#FDFCFD] text-[16px]   font-normal'>
              <p className="py-1">
        ...
        <div className='col-span-4 md:col-span-1  p-3 md:p-5 '>
          ...
          <ul className="text-[#FDFCFD] font-normal text-[16px] ">
            <li className="py-2 ">
            ...
            <li className='py-2 '>
              <Link to={'/'} className="hover:underline"><i className="fa-regular fa-clock me-2 text-xl"></i>
              <p>Open Hrs:  Mon-Sat: 10AM - 10 PM</p>
              </Link>
            </li>
          </ul>
        </div>
