...
const Patient = () => {
    return (
        <div className='bg-[#32856E] my-10  py-5 md:p-16 px-5 md:px-20 bg-img-fea '>
            <h1 className='text-2xl md:text-[2.2rem] font-semibold text-white'>Elevate Patient Care with HealTether</h1>
            ...
            <button className='bg-[#F5F5F5] p-2 my-2 rounded-md font-bold tracking-tight px-7 shadow-2xl'>Sign up now</button>
        </div>
