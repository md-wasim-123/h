             ...
             <h1 className='text-2xl md:text-[2.2rem] font-semibold text-black px-3  py-8'>Connect with us</h1>
                <div className="flex flex-wrap w-full mb-6">
                    <div className="w-1/2 px-3 mb-6 md:mb-0">
                        <label className="block tracking-wide   text-[18px] font-medium mb-2" for="grid-first-name">
                            Your name
                        </label>
                    ...
                    <div className="w-1/2 px-3 mb-6 md:mb-0">
                        <label className="block md:tracking-wide text-[18px] font-medium md:mb-2" for="grid-first-name">
                        Mobile no.
                        </label>
