 ...
 const data = [
    {
        ...
        des: 'Incorporate telemedicine features to facilitate remote consultations, enabling doctors to connect with patients virtually for follow-ups or initial assessments.'
    },
    {
        img: fr2,
        title: 'Simplify Scheduling',
        des: 'Say goodbye to long waiting times. Book appointments with just a 3 clicks and choose from a wide range of available time slots that fit your schedule.'
    },
    {
        img: fr3,
